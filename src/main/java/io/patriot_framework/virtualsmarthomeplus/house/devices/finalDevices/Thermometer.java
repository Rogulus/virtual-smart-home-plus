...
import io.patriot_framework.virtualsmarthomeplus.house.devices.Sensor;
...
public class Thermometer extends Sensor {
    ...
    public Thermometer(String label, String unit) {
        super(label);
        DataFeed dataFeed = new NormalDistVariateDataFeed(25, 1);
        dataFeed.setLabel("0");
        device = new io.patriot_framework.generator.device.impl.basicSensors.Thermometer(
                getLabel(),
                dataFeed
        );
        LOGGER.info("Registering to CoAP server");
