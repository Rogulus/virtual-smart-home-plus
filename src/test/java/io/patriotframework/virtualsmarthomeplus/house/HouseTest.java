...
public class HouseTest {
    ...
    public void houseIsByDefaultEmpty() {
        Set<Device> devices = house.getDevicesOfType(Device.class);
    ...
    public void updateDeviceThrowsExceptions() {
        ...
        assertThrows(NoSuchElementException.class, () -> house.updateDevice(new Fireplace("notPresent")));
    }

    @Test
    public void removeDeviceThrowsExceptions() {
        assertThrows(IllegalArgumentException.class, () -> house.removeDevice(null));
        assertThrows(NoSuchElementException.class, () -> house.removeDevice(new Fireplace("notPresent")));
    }
    ...
    public void deleteOnEmptyHouse() {
        assertThrows(NoSuchElementException.class, () -> house.removeDevice(new Fireplace("label")));
    }
    ...
    public void removeDeviceWorks() {
        ...
        house.removeDevice(fireplace1);
        assertThrows(NoSuchElementException.class, () -> house.getDevice(fireplace1.getLabel()));
        house.removeDevice(fireplace2);
        house.removeDevice(door1);
