...
public class HouseTest {
    ...
    public void addAndGetDeviceTest() {
        ...
        Assertions.assertEquals(house.getDevice("HouseDoor1"),door1);
    }
    ...
    public void getDeviceOfType() {
        ...
        house.addDevice(door2);
        house.addDevice(door1);
        Assertions.assertEquals(house.getDeviceOfType(Door.class,"HouseDoor1"),door1);
        Assertions.assertEquals(house.getDeviceOfType(RGBLight.class,"HouseRGB"),rgbLight);
